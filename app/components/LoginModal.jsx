...
import { Close, Google, Policy, VisibilityOffOutlined, VisibilityOutlined } from '@mui/icons-material';
import IconButton from '@mui/material/IconButton';
import CircularProgress from '@mui/material/CircularProgress';

const LoginModal = () => {
    const router = useRouter();
    const { authError, createAccount, login, setAuthError } = useAuthContext();
                ...
                <div className={styles.loginContainer}>
                    ...
                    <div className={styles.loginContainerBody}>
                        ...
                        <div className={styles.form}>
                            ...
                            <button className={styles.providerButton} onClick={handleClose}>
                                <Policy />
